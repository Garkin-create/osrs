...
namespace OSRS.Infrastructure.Migrations
{
    ...
    [Migration("20240429211818_Add post object")]
    partial class Addpostobject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OSRS.Domain.Entities.Post.PostObject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OSRS.Domain.Entities.Traking.TrackingObject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("OSRS.Domain.Entities.Traking.TrackingObject", b =>
                {
                    b.HasOne("OSRS.Domain.Entities.KeywordObject", "Keyword")
                        .WithMany("Trackings")
