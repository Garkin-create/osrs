...
### 2. Run
```ruby
  > dotnet new --install ASPNETecomerce.nuspec::3.0.5
  ```
### 3. Create an empty folder for your solution and cd into it.
### 4. Run the following code and enter your project name instead of MyNewecomerce

```ruby
  > dotnet new ASPNETecomerce -n MyNewecomerce
  ```
