...
using LinqKit;
using FilteringOption = OSRS.Application.Seed.Models.Input.FilteringOption;

namespace OSRS.Application.Seed.Utils
{
    public static class Operations
        ...
        public static IQueryable<T> WhereOr<T>(this IQueryable<T> query, List<Tuple<Models.Input.FilteringOption, Expression<Func<T, bool>>>> filterList)
        {
            if (filterList == null)
                return query;
        ...
        public static IQueryable<T> WhereAnd<T>(this IQueryable<T> query, List<Tuple<Models.Input.FilteringOption, Expression<Func<T, bool>>>> filterList)
        {
            if (filterList == null)
                return query;
