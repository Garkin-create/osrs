namespace OSRS.Api
{
    ...
    public static class DependencyInjection
    {
        ...
        public static IApplicationBuilder UseAppSwagger(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "OSRS.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "OSRS.WebUI v2");
